...
window.webcam = {
	...
	swf_url: 'isi/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'isi/shutter.mp3', // URI to shutter.mp3 sound
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : 'isi/shutter.mp3';
	},
